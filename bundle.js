...
var Select = React.createClass({
   ...
   */
	...
	componentDidUpdate: function componentDidUpdate(prevProps, prevState) {
		...
		menuContainerDOM.style.width === "unset" ? menuContainerDOM.offsetWidth + getScrollbarWidth() : menuContainerDOM.offsetWidth, thisDOM.offsetWidth) + "px";
	...
	render: function render() {
		...
		var menu = React.createElement(
			'div',
			_extends({ ref: 'selectMenuContainer' }, menuContainerProps),
			React.createElement(
				'div',
				menuProps,
				this.buildMenu()
